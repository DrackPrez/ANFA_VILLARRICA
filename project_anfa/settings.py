"""
Django settings for project_anfa project.
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'app_main', 'static'),
    # Agrega aquí otras carpetas si tienes archivos estáticos fuera de las apps
]
